...
response = requests.post(
    "http://software-container:5000/run-mallet",
    json={"command": "import-dir --input sample_data --output topic-input"},
)
print("MALLET Output:", response.json())

# Query WordNet
response = requests.get(
    "http://software-container:5000/wordnet", params={"word": "computer"}
)
