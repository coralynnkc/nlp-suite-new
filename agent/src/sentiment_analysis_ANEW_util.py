...
if not os.path.isfile(anew):
    print(
        "The file "
        + anew
        + " could not be found. The ANEW sentiment analysis routine expects a csv dictionary file 'EnglishShortenedANEW.csv' in a directory 'lib' expected to be a subdirectory of the directory where the sentiment_analysis_ANEW.py script is stored.\n\nPlease, check your lib directory and try again."
    )
    sys.exit()
