...
def generate_kml(inputFilename, inputGeocodedCsvFile,
				 datePresent,
				 locationColumnName,
				 encodingValue,
				 group_var, group_number_var, group_values_entry_var_list, group_label_entry_var_list,
	...
	startTime = IO_user_interface_util.timed_alert(2000, 'GIS kml generator', 'Started running KML algorithm at',
	...
	# Mapping with multiple groups
		...
		for j in range(group_number_var):
			...
			for row in inputfile:
				...
				index = index + 1
	IO_user_interface_util.timed_alert(2000, 'GIS kml generator', 'Finished running KML algorithm at', True, '',
