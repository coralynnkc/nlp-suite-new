...
def compute_word2vec_distances(
    ...
    if n_dim_Euclidean:
        ...
        outputFiles = charts_util.visualize_chart(
            ...
            dist_outputFilename,
            outputDir,
            columns_to_be_plotted_xAxis=["Word_1_2"],
            columns_to_be_plotted_yAxis=["n-dimensional Euclidean distance"],
    ...
    if not BERT:
        if compute_cosine_similarity:  # now always set to True
            ...
            outputFiles = charts_util.visualize_chart(
                ...
                outputDir,
                columns_to_be_plotted_xAxis=["Word_1_2"],
                columns_to_be_plotted_yAxis=["Cosine similarity"],
...
def euclidean_dist(x, y):
    return math.sqrt(sum((p1 - p2) ** 2 for p1, p2 in zip(x, y, strict=False)))
