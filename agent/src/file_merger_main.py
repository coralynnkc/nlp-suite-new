...
def run(
    ...
    if not IO_libraries_util.check_inputPythonJavaProgramFile("file_merger_util.py"):
        return
...
merge_embed_filenames_inStringSeparators_checkbox = tk.Checkbutton(
    window,
    text="Embed filename in separators",
    variable=merge_embed_filenames_inStringSeparators_var,
    onvalue=1,
    offvalue=0,
)
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.file_merger_merge_embed_filenames_inStringSeparators_pos,
    y_multiplier_integer,
    merge_embed_filenames_inStringSeparators_checkbox,
    True,
)
...
def display_merge_separator(y_multiplier_integer):
    ...
    y_multiplier_integer = GUI_IO_util.placeWidget(
        window,
        GUI_IO_util.file_merger_merge_separator_entry_begin_pos,
        y_multiplier_integer,
        merge_separator_entry_begin,
        True,
    )
    ...
    y_multiplier_integer = GUI_IO_util.placeWidget(
        window,
        GUI_IO_util.file_merger_merge_separator_entry_end_pos,
        y_multiplier_integer,
        merge_separator_entry_end,
        True,
    )
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.file_merger_merge_embed_subdir_name_pos,
    y_multiplier_integer,
    merge_embed_subdir_name_checkbox,
    True,
)
