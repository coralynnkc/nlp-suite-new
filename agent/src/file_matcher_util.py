...
def run_default(
    ...
    matched_filename = (
        in_search_path[0]
        + os.sep
        + os.path.basename(os.path.normpath(in_search_path[0]))
        + "_matched_"
        + start_type
        + "_"
        + end_type
    ...
    mb.showwarning(
        title="OUTPUT folder",
        message="For easiness of reading, regardless of your selected OUTPUT folder in I/O Configuration, all three output files for matched, unmatched, and duplicate files have been saved to the INPUT folder\n\n"
