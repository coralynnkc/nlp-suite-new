from .data.countries import ISO_GIS_country_menu, countries
from .data.languages import ISO_language_menu, languages
from .data.nlp_menus import (
...
from .data.ontologies import DBpedia_ontology_class_menu, YAGO_ontology_class_menu
