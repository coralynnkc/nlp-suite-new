...
def adjective_POSTAG_NER_DEPREL_compute_lists_frequencies(data, data_divided_sents):
    ...
    adjective_postag_stats = [
        ["Adjective POS Tags", "Frequencies"],
...
def adjective_stats(
    ...
    (
        adjective_postag_list,
        adjective_postag_stats,
        adjective_deprel_list,
        adjective_deprel_stats,
        adjective_ner_list,
        adjective_ner_stats,
    ) = compute_stats(data)
    ...
    (
        ...
        adjective_deprel_stats,
        adjective_ner_stats,
    ) = adjective_POSTAG_NER_DEPREL_compute_lists_frequencies(data, data_divided_sents)
    ...
    adjective_ner_list_file_name = IO_files_util.generate_output_file_name(
        inputFilename, "", outputDir, ".csv", "AVA", "Adjective", "NER_list"
    )
