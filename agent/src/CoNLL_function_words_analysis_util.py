...
def stats_pronouns_output(data, data_divided_sents):
    ...
    pronouns_postag_stats = [
        ["PRONOUN ANALYSIS", "FREQUENCY"],
        [
        ...
        [
            "WH-pronoun (WP)",
            postag_counter["WP"],
        ],  # what, who, whom, whoever (which for CoreNLP is WDT Wh-determiner, not a WP Wh-pronoun
...
def stats_prepositions_output(data, data_divided_sents):
    ...
    postag_list, postag_counter, deprel_list, deprel_counter = compute_stats(data)
    # must be sorted in descending order
    prepositions_postag_stats = [
        ["PREPOSITION ANALYSIS", "FREQUENCY"],
...
def stats_determiners_articles_output(data, data_divided_sents):
    ...
    postag_list, postag_counter, deprel_list, deprel_counter = compute_stats(data)
    # must be sorted in descending order
    articles_postag_stats = [
        ["DETERMINER/ARTICLE ANALYSIS", "FREQUENCY"],
...
def stats_conjunctions_output(data, data_divided_sents):
    ...
    postag_list, postag_counter, deprel_list, deprel_counter = compute_stats(data)
    # must be sorted in descending order
    conjunctions_postag_stats = [
        ["CONJUNCTION ANALYSIS", "FREQUENCY"],
...
def stats_auxiliaries_output(data, data_divided_sents):
    ...
    postag_list, postag_counter, deprel_list, deprel_counter = compute_stats(data)
    # must be sorted in descending order
    auxiliaries_deprel_stats = [
        ["AUXILIARY ANALYSIS", "FREQUENCY"],
