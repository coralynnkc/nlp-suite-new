...
def search_sentences_documents(
    ...
    # visualize results for within sentence searches ---------------------------------------------------------------
        ...
        if not search_keywords_found:
            ...
            outputFiles = visualize_wordcloud(
                all_found_sentences_allDocs,
                search_keywords_str,
                "all_sents_with_searchwords",
                inputFilename,
                inputDir,
                outputDir,
                configFileName,
...
def visualize_wordcloud(
    ...
    if len(textToProcess) < 15:
        print(
            "Warning",
            'The text required to produce a wordcloud is too short.\n"' + textToProcess + "\n\nWordcloud exits.",
        )
        return
