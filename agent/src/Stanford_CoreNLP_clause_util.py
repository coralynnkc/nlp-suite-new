...
def clausal_info_extract(parsetree):
    ...
    try:
        ...
        print("\nERROR IN PARSE-TREE\n",parsetree)
        print('ERROR IN PARSE-TREE', "There was an error in parsing the tree of a sentence for the full_list displayed in command line.")
