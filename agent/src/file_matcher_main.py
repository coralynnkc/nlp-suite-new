...
y_multiplier_integer = GUI_IO_util.placeWidget(
    ...
    90,
    GUI_IO_util.labels_x_coordinate,
    "Click on the button to select the csv file to be used to find file matches",
)
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window,
    GUI_IO_util.file_matcher_openInputFile_button_pos,
    y_multiplier_integer,
...
matching_var.set(1)
matching_checkbox = tk.Checkbutton(
    window,
    variable=matching_var,
    onvalue=1,
    offvalue=0,
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window, GUI_IO_util.open_TIPS_x_coordinate, y_multiplier_integer, character_lb, True
)
...
include_exclude_checkbox = tk.Checkbutton(
    window,
    variable=include_exclude_var,
    onvalue=1,
    offvalue=0,
    command=lambda: GUI_util.trace_checkbox_NoLabel(
...
y_multiplier_integer = GUI_IO_util.placeWidget(
    window, GUI_IO_util.open_TIPS_x_coordinate, y_multiplier_integer, move_checkbox
)
